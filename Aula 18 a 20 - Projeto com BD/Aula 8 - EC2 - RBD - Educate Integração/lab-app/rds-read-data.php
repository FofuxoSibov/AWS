...
<?php
  ...
  mysqli_connect($RDS_URL, $RDS_user, $RDS_pwd, RDS_DB) or die(mysql_error());

  mysqli_select_db($RDS_DB) or die(mysqli_error());
...
if ( $mode=="add")
 ...
 if ( $mode=="added")
 {
 mysqli_query ("INSERT INTO address (lastname, firstname, phone, email) VALUES ('$lastname', '$firstname', '$phone', '$email')");
 }
...
if ( $mode=="edit")
 ...
 if ( $mode=="edited")
 {
 mysqli_query ("UPDATE address SET lastname = '$lastname', firstname = '$firstname', phone = '$phone', email = '$email' WHERE id = $id");
...
if ( $mode=="remove")
 ...
 $data = mysqli_query("SELECT * FROM address ORDER BY lastname ASC")
 or die(mysql_error());
